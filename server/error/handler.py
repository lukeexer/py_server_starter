...
def internal_server_error(exp):
    ...
    return SJson.make_error_json(ErrCode.INTERNAL_SERVER_ERROR,
...
def resource_not_found(exp):
    ...
    return SJson.make_error_json(ErrCode.RESOURCE_NOT_FOUND,
...
def method_not_allowed(exp):
    ...
    return SJson.make_error_json(ErrCode.METHOD_NOT_ALLOWED,
...
def handle_all_exception(exp):
    ...
    return SJson.make_error_json(ErrCode.UNKNOWN_ERROR,
